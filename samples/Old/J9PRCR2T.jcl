...
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//SC02PERD DD DSN=&MIG.CRE32.C02PERD,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//*----------------------------------------------------------------
...
/*
//*----------------------------------------------------------------
//*TRI DU FICHIER C02PERD
//*----------------------------------------------------------------
//SORT3202 EXEC PGM=SORT,COND=(0,NE)
//* DEBUT CRITERE XGEN
//* SC02PERD SORT C02-PER-DEB-CTX-C-ID-PER-DEBIT ASC [15:12—
//* FIN   CRITERE XGEN
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DISP=SHR,DSN=&SRC.C02PERDE
//SORTOUT  DD DSN=&MIG.CRE32.C02PERD,
//            DISP=(NEW,CATLG,DELETE),DCB=*.SORTIN,
//            SPACE=(TRK,(5000,500),RLSE)
//SYSIN    DD *
...
//SC02PERD DD DISP=SHR,DSN=&MIG.CRE32.C02PERD
//*--------------<FICHIERS CIBLES>---------------------------------
//STRECCRE DD DSN=&MIG.CRE32.TRECCRE,
//            DISP=(NEW,CATLG,CATLG),
//            SPACE=(TRK,(200,100),RLSE)
...
//         DD DISP=SHR,DSN=&MIG.CRE06.FPERD4
//         DD DISP=SHR,DSN=&MIG.CRE07.FPERD5
//         DD DISP=SHR,DSN=&MIG.CRE14.FPERD6
...
//*----------------------------------------------------------------
//*----------------------------------------------------------------
//*STEP DE SUPPRESSION DES FICHIERS TRIES DU PGM PVHCRE46
//*----------------------------------------------------------------
//DEL4601       EXEC PGM=IEFBR14,COND=(0,NE)
//SYSPRINT DD SYSOUT=*
//SWKEREC  DD DSN=&MIG.CRE46.WKEREC,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//SDOSSCTX DD DSN=&MIG.CRE46.DOSSCTX,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//*----------------------------------------------------------------
//*TRI DU FICHIER WKEREC
//*----------------------------------------------------------------
//SORT4601 EXEC PGM=SORT,COND=(0,NE)
//* DEBUT CRITERE XGEN
//* SWKEREC SORT WKX-C-ID-DOSS ASC [197:12—
//* FIN   CRITERE XGEN
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DISP=SHR,DSN=&MIG.CRE32.TRECCRE
//SORTOUT  DD DSN=&MIG.CRE46.WKEREC,
//            DISP=(NEW,CATLG,DELETE),DCB=*.SORTIN,
//            SPACE=(TRK,(5000,500),RLSE)
//SYSIN    DD *
  SORT FIELDS=(197,12,CH,A)
/*
//*----------------------------------------------------------------
...
//SORTOUT  DD DSN=&MIG.CRE46.DOSSCTX,
//            DISP=(NEW,CATLG,DELETE),DCB=*.SORTIN,
//            SPACE=(TRK,(5000,500),RLSE)
//SYSIN    DD *
  SORT FIELDS=(1,12,CH,A)
...
//SYSPRINT DD SYSOUT=*
//SWKSREC  DD DSN=&MIG.CRE46.WKSREC,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//*----------------------------------------------------------------
//*STEP DE SUPPRESSION DES FICHIERS TECHNIQUES DU PGM
//*----------------------------------------------------------------
...
//SYSPRINT DD SYSOUT=*
//FANO     DD DSN=&ANO.PVHCRE46,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//FCPT     DD DSN=&CPT.PVHCRE46,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//FTRC     DD DSN=&TRC.PVHCRE46,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//*----------------------------------------------------------------
//*STEP D EXECUTION DU PROGRAMME DE MIGRATION PVHCRE46
//*----------------------------------------------------------------
//PVHCRE46 EXEC PGM=PVHCRE46,COND=(0,NE)
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//ANOMAL   DD DSN=&ANO.PVHCRE46,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(5000,500),RLSE)
//COMPTEUR DD DSN=&CPT.PVHCRE46,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(500,50),RLSE)
//FICTRACE DD DSN=&TRC.PVHCRE46,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(500,50),RLSE)
//FWORMAJ  DD DISP=SHR,DSN=&PARAM
//NSPITAB  DD DISP=SHR,DSN=&SPITAB
//*--------------<FICHIERS SOURCES>--------------------------------
//SWKEREC  DD DISP=SHR,DSN=&MIG.CRE46.WKEREC
//SDOSSCTX DD DISP=SHR,DSN=&MIG.CRE46.DOSSCTX
//*--------------<FICHIERS CIBLES>---------------------------------
//SWKSREC  DD DSN=&MIG.CRE46.WKSREC,
//            DISP=(NEW,CATLG,CATLG),
//            SPACE=(TRK,(200,100),RLSE)
...
//* FIN   CRITERE XGEN
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DISP=SHR,DSN=&MIG.CRE46.WKSREC
...
//*----------------------------------------------------------------
//*----------------------------------------------------------------
//*STEP DE SUPPRESSION DES FICHIERS TRIES DU PGM PVHCRE45
//*----------------------------------------------------------------
//DEL4501       EXEC PGM=IEFBR14,COND=(0,NE)
//SYSPRINT DD SYSOUT=*
//SWK1ORC  DD DSN=&MIG.CRE45.WK1ORC,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//*----------------------------------------------------------------
//*TRI DU FICHIER WK1ORC
//*----------------------------------------------------------------
//SORT4501 EXEC PGM=SORT,COND=(0,NE)
//* DEBUT CRITERE XGEN
//* SWK1ORC SORT ORC-IDTECADH ASC [16:20—
//* SWK1ORC SORT ORC-NOORDADS ASC [36:3—
//* SWK1ORC SORT ORC-NOORDUEC ASC [39:5—
//* SWK1ORC SORT ORC-TYINS ASC [44:1—
//* SWK1ORC SORT ORC-NOINS ASC [45:4—
//* SWK1ORC SORT ORC-ANPER ASC [70:4—
//* SWK1ORC SORT ORC-COPERREF ASC [74:3—
//* SWK1ORC SORT ORC-TYLIGCRE ASC [69:1—
//* FIN   CRITERE XGEN
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DISP=SHR,DSN=&MIG.CRE44.ORC
//SORTOUT  DD DSN=&MIG.CRE45.WK1ORC,
//            DISP=(NEW,CATLG,DELETE),DCB=*.SORTIN,
//            SPACE=(TRK,(5000,500),RLSE)
//SYSIN    DD *
  SORT FIELDS=(16,20,CH,A,
...
//SYSPRINT DD SYSOUT=*
//FANO     DD DSN=&ANO.PVHCRE45,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//FCPT     DD DSN=&CPT.PVHCRE45,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//FTRC     DD DSN=&TRC.PVHCRE45,
//            DISP=(MOD,DELETE),SPACE=(TRK,0)
//*----------------------------------------------------------------
//*STEP D EXECUTION DU PROGRAMME DE MIGRATION PVHCRE45
//*----------------------------------------------------------------
//PVHCRE45 EXEC PGM=PVHCRE45,COND=(0,NE)
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//ANOMAL   DD DSN=&ANO.PVHCRE45,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(5000,500),RLSE)
//COMPTEUR DD DSN=&CPT.PVHCRE45,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(500,50),RLSE)
//FICTRACE DD DSN=&TRC.PVHCRE45,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(500,50),RLSE)
//FWORMAJ  DD DISP=SHR,DSN=&PARAM
//NSPITAB  DD DISP=SHR,DSN=&SPITAB
//*--------------<FICHIERS SOURCES>--------------------------------
//SWK1ORC  DD DISP=SHR,DSN=&MIG.CRE45.WK1ORC
//SWK2ORC  DD DISP=SHR,DSN=&MIG.CRE45.WK1ORC
//*--------------<FICHIERS CIBLES>---------------------------------
//SORC     DD DSN=&MIG.CRE45.ORC,
//            DISP=(NEW,CATLG,CATLG),
//            SPACE=(TRK,(200,100),RLSE)
...
//* FIN   CRITERE XGEN
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DISP=SHR,DSN=&MIG.CRE45.ORC
